        ...
        **********************************************************************************
        ...
        OBJECTIVE :
	- This sample demonstrates how to compute HMAC-SHA256 signature.
	- Login will use Crypto-Officer password.
	- This sample uses CKM_SHA256_HMAC mechanism, which in java security is known as "HMACSHA256".
*/
...
public class HMACUsing_SHA256 {
	...
	private static void printUsage() {
		System.out.println(" [ HMACUsing_SHA256 ]\n");
		System.out.println("Usage-");
		System.out.println("java HMACUsing_SHA256 <slot_label> <crypto_officer_password>\n");
		System.out.println("Example -");
		System.out.println("java HMACUsing_SHA256 myPartition userpin\n");
	}
	...
	private static void generateCMAC() throws Exception {
		...
		System.out.println("HMAC-SHA-256: " + LunaUtils.getHexString(signature, false));
    	}
