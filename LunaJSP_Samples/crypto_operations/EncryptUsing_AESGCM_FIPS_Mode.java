	...
	- HSM generates IV internally within the cryptographic module for AES-GCM encryption in FIPS mode.
	- IV generated by HSM is appended to the ciphertext.
*/
...
public class EncryptUsing_AESGCM_FIPS_Mode {
	...
	private static byte[] initializationVector = "".getBytes();
	...
	private static void printUsage() {
		System.out.println(" [ EncryptUsing_AESGCM_FIPS_Mode ]\n");
		System.out.println("Usage-");
		System.out.println("java EncryptUsing_AESGCM_FIPS_Mode <slot_label> <crypto_officer_password>\n");
		System.out.println("Example -");
		System.out.println("java EncryptUsing_AESGCM_FIPS_Mode myPartition userpin\n");
	}
	...
	private static void encryptData() throws Exception {
		gcmSpec = new GCMParameterSpec(TAG_BITS, initializationVector); // initializing GCMParamaters with tagbit and a blank IV.
		...
		initializationVector = encrypt.getIV(); // READ IV appended to the CipherText.
	}
