	...
	- This sample uses CKM_RSA_PKCS mechanism which in java security is known as "RSA/None/PKCS1Padding" or simple "RSA".
	- This sample may fail if your Luna HSM is configured to operate in FIPS mode. CKM_RSA_PKCS is not considered FIPS compliant.
...
public class EncryptUsing_RSA_PKCS {
	...
	private static void printUsage() {
		System.out.println("[ EncryptUsing_RSA_PKCS ]\n");
		System.out.println("Usage-");
		System.out.println("java EncryptUsing_RSA_PKCS <slot_label> <crypto_officer_password>\n");
		System.out.println("Example -");
		System.out.println("java EncryptUsing_RSA_PKCS myPartition userpin\n");
	}
	...
	private static void encryptData() throws Exception {
		Cipher encrypt = Cipher.getInstance("RSA/None/PKCS1Padding", PROVIDER);
	...
	private static void decryptData() throws Exception {
		Cipher decrypt = Cipher.getInstance("RSA/None/PKCS1Padding", PROVIDER);
