        ...
        **********************************************************************************
        ...
        - This sample uses CKM_RSA_X_509 mechanism which in java security is known as "RSA/None/NoPadding".
        - This sample may fail if your Luna HSM is configured to operate in FIPS mode. CKM_RSA_X_509 is disallowed in FIPS mode.
*/
...
public class EncryptUsing_RSA_X_509 {
	...
	private static void printUsage() {
		System.out.println("[ EncryptUsing_RSA_X_509 ]\n");
		System.out.println("Usage-");
		System.out.println("java EncryptUsing_RSA_X_509 <slot_label> <crypto_officer_password>\n");
		System.out.println("Example -");
		System.out.println("java EncryptUsing_RSA_X_509 myPartition userpin\n");
	}
	...
	private static void encryptData() throws Exception {
		Cipher encrypt = Cipher.getInstance("RSA/None/NoPadding", PROVIDER);
	...
	private static void decryptData() throws Exception {
		Cipher decrypt = Cipher.getInstance("RSA/None/NoPadding", PROVIDER);
