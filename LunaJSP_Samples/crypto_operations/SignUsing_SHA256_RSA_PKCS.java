	...
	- This sample uses CKM_RSA_PKCS mechanism to sign a pkcs1-padded SHA256 hash which in java security is known as "sha256WithRSA".
...
public class  SignUsing_SHA256_RSA_PKCS {
	...
	private static void printUsage() {
		System.out.println("[ SignUsing_SHA256_RSA_PKCS ]\n");
		System.out.println("Usage-");
		System.out.println("java SignUsing_SHA256_RSA_PKCS <slot_label> <crypto_officer_password>\n");
		System.out.println("Example -");
		System.out.println("java SignUsing_SHA256_RSA_PKCS myPartition userpin\n");
	}
